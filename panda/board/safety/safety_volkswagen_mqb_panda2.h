...
const CanMsg VOLKSWAGEN_MQB_PANDA2_TX_MSGS[] = {
                                                //Blinker
                                                {MSG_BLINKMODI_02, 4, 8}, {MSG_BLINKMODI_02, 5, 8}, {MSG_BLINKMODI_02, 6, 8},
                                                {MSG_LICHT_ANF_01, 4, 8},
                                                {MSG_GATEWAY_72, 4, 8}, {MSG_GATEWAY_72, 5, 8}, {MSG_GATEWAY_72, 6, 8},
                                                {MSG_980_0x3d4, 6, 8},
                                                //Area view
                                                {MSG_PARKHILFE_01, 4, 8}, {MSG_PARKHILFE_01, 5, 8},
                                                {MSG_896_0x380_APS_Master, 5, 8},
                                                {MSG_898_0x382_APS_02, 5, 8},
                                                {MSG_986_0x3da, 4, 8},
                                                {MSG_1711_0x6af, 4, 8}, {MSG_1711_0x6af, 5, 8},
                                                };
