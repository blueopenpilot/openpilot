...
class CarController:
  ...
  def update(self, CC, CS, ext_bus, now_nanos):
    ...
    ###### BCM_01 #####
    if self.CP.vagCanModule.bus0Bcm01 and self.CP.vagCanModule.bus0Motor18:
      if CC.disableVagStartStop:
    ...
    ###### CHARISMA_01 #####
    if self.CP.vagCanModule.bus0Charisma01 and self.CP.vagCanModule.bus0Charisma07:
      if CC.enableVagDrivingMode or CC.enableVagDynamicDcc:
        if self.frame % self.CCP.CHARISMA_01_STEP == 0:
          can_sends.append(self.CCS.create_charisma_01_control(self.packer_pt, CANBUS.body, CS.charisma_01, CS.charisma_07, CC.enableVagDrivingMode, CC.vagDrivingMode, CC.enableVagDynamicDcc, CS.out.vagUiField.speed, CS.out.steeringAngleDeg))
    ...
    if self.frame % self.CCP.STEER_STEP == 0:
      ...
      vibratorEnabled = 0
      if (CC.availableVagBlindspotInfoVibrator):
        vibratorEnabled = 1
      if (CC.availableVagBlindspotWarningVibrator):
        vibratorEnabled = 2
