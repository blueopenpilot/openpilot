...
void VagTestPanel::showEvent(QShowEvent *event) {
  UIState *s = uiState();
  const bool bus0Charisma01 = (*s->sm)["carState"].getCarState().getVagCanModule().getBus0Charisma01();
  const bool bus0Charisma07 = (*s->sm)["carState"].getCarState().getVagCanModule().getBus0Charisma07();
...
void VagFeaturePanel::showEvent(QShowEvent *event) {
  ...
  // ----- Force disable startstop -----
  UIState *s = uiState();
  const bool bus0Bcm01 = (*s->sm)["carState"].getCarState().getVagCanModule().getBus0Bcm01();
  const bool bus0Motor18 = (*s->sm)["carState"].getCarState().getVagCanModule().getBus0Motor18();
