...
#if 0
  //TODO: Add a rectagle
  painter.setViewport(30, 30, 1920, 1080);
...
void VagHudWindow::drawVagHud(QPainter &painter) {
  ...
  // ===== Engine =====
  QRectF rectangleEngine(30.0, 30.0, 660.0, 510.0);
  ...
  const float moOeldruck = (*s->sm)["carState"].getCarState().getVagUiField().getMoOeldruck();
  ...
  const float moRelSaugrohrdruck = (*s->sm)["carState"].getCarState().getVagUiField().getMoRelSaugrohrdruck()/1000;
  ...
  // ===== Gearbox =====
  QRectF rectangleGearbox(30.0, 540.0, 465.0, 510.0);
  ...
  // ===== Coolant =====
  QRectF rectangleCoolant(495.0, 540.0, 465.0, 510.0);
  ...
  painter.drawPixmap(555, 590, imgSize, imgSize, imgEngineCoolant);
  font.setPointSize(8);
  painter.setFont(font);
  ...
  painter.drawText(763, 550, 1800, 200, Qt::AlignVCenter+Qt::AlignLeft, QString(stringBuffer));
  // ----- Coolant -----
  ...
  painter.drawPixmap(555, 820, imgSize, imgSize, imgCoolant);
  font.setPointSize(8);
  painter.setFont(font);
  ...
  painter.drawText(763, 820, 1800, 200, Qt::AlignVCenter+Qt::AlignLeft, QString(stringBuffer));

  // ===== speed =====
  QRectF rectangleSpeed(690.0, 30.0, 735.0, 510.0);
  ...
  painter.drawPixmap(763, 80, imgSize, imgSize, imgSpeedometer);
  font.setPointSize(15);
  painter.setFont(font);
  const float speed = (*s->sm)["carState"].getCarState().getVagUiField().getSpeed();
  ...
  painter.drawText(1250, 100, 1800, 200, Qt::AlignVCenter+Qt::AlignLeft, QString(stringBuffer));
  // ----- rpm -----
  ...
  painter.drawPixmap(763, 335, imgSize, imgSize, imgRpm);
  font.setPointSize(15);
  painter.setFont(font);
  ...
  painter.drawText(1250, 355, 1800, 200, Qt::AlignVCenter+Qt::AlignLeft, QString(stringBuffer));

  // ===== Temperature =====
  QRectF rectangleTemperatue(960.0, 540.0, 465.0, 510.0);
  ...
  painter.drawPixmap(1040, 590, imgSize, imgSize, imgIndoorTemparature);
  font.setPointSize(9);
  painter.setFont(font);
  ...
  painter.drawPixmap(1040, 830, imgSize, imgSize, imgOutdoorTemparature);
  font.setPointSize(9);
  painter.setFont(font);
  ...
  // ===== Battery =====
  QRectF rectangleBatteryVoltage(1425.0, 30.0, 465.0, 255.0);
  ...
  painter.drawPixmap(1500, 80, imgSize, imgSize, imgBattery);
  font.setPointSize(9);
  painter.setFont(font);
  float voltage = 0;
  ...
  painter.drawText(1500, 50, 350, 200, Qt::AlignVCenter+Qt::AlignRight, QString(stringBuffer));

  // ===== Turbo =====
  QRectF rectangleTurbo(1425.0, 285.0, 465.0, 255.0);
  ...
  painter.drawPixmap(1500, 335, imgSize, imgSize, imgTurbo);
  font.setPointSize(9);
  painter.setFont(font);  const float moLadedruck = (*s->sm)["carState"].getCarState().getVagUiField().getMoLadedruck();
  snprintf(stringBuffer, sizeof(stringBuffer), "%2.1f Bar", moLadedruck);
  painter.drawText(1500, 305, 350, 200, Qt::AlignVCenter+Qt::AlignRight, QString(stringBuffer));

  // ===== Brake =====
  QRectF rectangleBrake(1425.0, 540.0, 465.0, 255.0);
  ...
  painter.drawPixmap(1500, 590, imgSize, imgSize, imgBrake);
  font.setPointSize(9);
  painter.setFont(font);  const float espBremsdruck = (*s->sm)["carState"].getCarState().getVagUiField().getEspBremsdruck();
  snprintf(stringBuffer, sizeof(stringBuffer), "%2.1f Bar", espBremsdruck);
  painter.drawText(1500, 560, 350, 200, Qt::AlignVCenter+Qt::AlignRight, QString(stringBuffer));
}
