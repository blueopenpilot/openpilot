/****************************************************************************
** Meta object code from reading C++ file 'map_panel.h'
**
...
#error "The header file 'map_panel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 17), // "mapPanelRequested"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17) // "toggleMapSettings"

    },
    "MapPanel\0mapPanelRequested\0\0"
    "toggleMapSettings"
};
...
void MapPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->toggleMapSettings(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapPanel::mapPanelRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MapPanel::mapPanelRequested()
{
