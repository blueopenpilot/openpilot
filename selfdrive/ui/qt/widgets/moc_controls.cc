...
QT_MOC_LITERAL(4, 35, 16), // "setToggleVisible"
QT_MOC_LITERAL(5, 52, 7) // "visible"

    },
    "ToggleControl\0toggleFlipped\0\0state\0"
    "setToggleVisible\0visible"
};
#undef QT_MOC_LITERAL
...
void ToggleControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setToggleVisible((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
