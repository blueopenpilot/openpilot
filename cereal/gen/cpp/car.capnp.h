...
struct CarState {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(9da4fa09e052903c, 9, 9)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline float getVagSpeed() const;
...
public:
  ...
  inline float getVagSpeed();
  inline void setVagSpeed(float value);
...
inline float CarState::Reader::getVagSpeed() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}

inline float CarState::Builder::getVagSpeed() {
  return _builder.getDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setVagSpeed(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS, value);
}
