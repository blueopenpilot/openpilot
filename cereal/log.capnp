...
struct Event {
  ...
  union {
    ...
    vagCarState @107 :Custom.VagCarState;
    vagCarControl @108 :Custom.VagCarControl;
    vagCarParams @109 :Custom.VagCarParams;
    vagParam @110 :Custom.VagParam;
    vagControl @111 :Custom.VagControl;
