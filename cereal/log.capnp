...
struct VagParam {
  ...
  # ----- Lead car going -----
  isVagLeadCarGoingRemindEnabled @17 :Bool;
  isVagLeadCarGoingRemindSoundEnabled @18 :Bool;
  #//----- No lead car -----
  isVagNoLeadCarEnabled @19 :Bool;
  isVagNoLeadCarWarningSoundEnabled @20 :Bool;
  # ----- Vision presafe -----
  isVagVisionPresafeEnabled @21 :Bool;
  isVagVisionPresafeWarningSoundEnabled @22 :Bool;
  isVagVisionPresafeWarningInterposeEnabled @23 :Bool;
  # ---- Speed camera -----
  isVagSpeedCameraEnabled @24 :Bool;
  isVagSpeedLimitSoundEnabled @25 :Bool;
  isVagSaccEnabled @26 :Bool;

  # ===== Test =====
  isVagDebugOsdTestTextEnabled @27 :Bool;
  isVagRadarAccTestTextEnabled @28 :Bool;
  isVagVisionAccTestTextEnabled @29 :Bool;
  isVagDebugItem1Enabled @30 :Bool;
  isVagDebugItem2Enabled @31 :Bool;
  isVagDebugItem3Enabled @32 :Bool;
  isVagDebugItem4Enabled @33 :Bool;
  isVagDebugItem5Enabled @34 :Bool;

  # ===== Gerenal =====
  isVagDevelopModeEnabled @35 :Bool;
  isVagDevelopOnRoadUi @36 :Bool;
  isVagRunningProcessLogEnabled @37 :Bool;
  isVagParamFromCerealEnabled @38 :Bool;
  isVagLeftBlinkerSoundEnabled @39 :Bool;
  isVagRightBlinkerSoundEnabled @40 :Bool;

  # ===== OSD =====
  isVagDebugBlinkerTest @41 :Bool;
  isVagDebugBlindspotInfoTest @42 :Bool;
  isVagDebugBlindspotWarningTest @43 :Bool;
  isVagDebugBrakeLightTest @44 :Bool;
  isVagDebugLeadCarGoingRemindTest @45 :Bool;
  isVagDebugNoLeadCarWarningTest @46 :Bool;
  isVagDebugVisionPresafeTest @47 :Bool;

  # ===== Log =====
  isVagFlkaLogEnabled @48 :Bool;
  isVagSaccLogEnabled @49 :Bool;
  isVagSaccSpeedCamTrackEnabled @50 :Bool;
  isVagSaccVehicleTrackEnabled @51 :Bool;
}
...
struct Event {
  ...
  union {
    ...
    speedCamera @87 :SpeedCamera;
    speedCamera2 @88 :SpeedCamera2;
