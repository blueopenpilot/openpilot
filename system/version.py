...
RELEASE_BRANCHES = ['release3-staging', 'dashcam3-staging', 'release3', 'dashcam3', 'nightly', 'c3']
...
def is_comma_remote() -> bool:
  ...
  return origin.startswith(('bluetulippon@github.com:bluetulippon', 'https://github.com/bluetulippon'))
