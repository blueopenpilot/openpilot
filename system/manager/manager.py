...
def manager_init() -> None:
  ...
  default_params: list[tuple[str, str | bytes]] = [
    ...
    ("IsVagForceDisableStartstop", "0"),
    ("IsVagDrivingModeEnabled", "0"),
    ("VagDrivingMode", "2"),
    ("IsVagDynamicDccEnabled", "0"),
    # ===== Warning =====
    ("IsVagWarningEngineTurboPressure", "0"),
    ("IsVagWarningEngineOilPressure", "0"),
    ("IsVagWarningEngineInAirTemperature", "0"),
    ("IsVagWarningEngineCoolantTemperature", "0"),
    ("IsVagWarningEngineOilTemperature", "0"),
    ("IsVagWarningCoolantTemperature", "0"),
    ("IsVagWarningInAirPressure", "0"),
    ("IsVagWarningGearOilTemperature", "0"),
    ("IsVagWarningBrakePressure", "0"),
    ("IsVagWarningIndoorTemperature", "0"),
    ("IsVagWarningOutdoorTemperature", "0"),
