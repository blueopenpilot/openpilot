BlueOpenPilot version 0.8.13.4 (2024-05-20)
========================
 * Base on openpilot version 0.8.13.1 for O1/C2
 * NEOS downgrade to 19.1 (same as op0.8.13)
 * Add VAG Hud
 * Screen off (backlight off)
 * Remove Speed Camera

BlueOpenPilot version 0.8.13.1 (2022-06-29)
========================
