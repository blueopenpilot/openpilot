BlueOpenPilot version 0.9.7 (2024-XX-XX)
========================
 * Base on openpilot version 0.9.7 for C3
 * Add FLKA With Assistant
 * Add VAG HUD screen
 * Add force disable startstop
 * Add driving mode (beta)
 * Add Dynamic DCC (beta)
 * Seprate VAG settings from OP settings screen

BlueOpenPilot version 0.8.15 (2022-07-27)
========================
